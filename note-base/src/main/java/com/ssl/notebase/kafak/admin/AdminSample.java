package com.ssl.notebase.kafak.admin;
...
//        ConfigResource configResource = new ConfigResource(ConfigResource.Type.BROKER, TOPIC_NAME);
    ...
    /*
        删除Topic
     */
    public static void delTopics(List<String> topicNames) throws Exception {
        AdminClient adminClient = adminClient();
...
//        ListTopicsResult listTopicsResult = adminClient.listTopics();
    ...
    public static AdminClient adminClient() {
        ...
        properties.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, HOST_NAME);
