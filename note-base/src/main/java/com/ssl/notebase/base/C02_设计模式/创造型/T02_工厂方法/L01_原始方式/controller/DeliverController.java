package com.ssl.notebase.base.C02_设计模式.创造型.T02_工厂方法.L01_原始方式.controller;


import com.ssl.notebase.base.C02_设计模式.创造型.T02_工厂方法.L01_原始方式.entity.AwardInfo;
...
import com.ssl.notebase.base.C02_设计模式.创造型.T02_工厂方法.L01_原始方式.service.DiscountService;
import com.ssl.notebase.base.C02_设计模式.创造型.T02_工厂方法.L01_原始方式.service.SmallGiftService;
import com.ssl.notebase.base.C02_设计模式.创造型.T02_工厂方法.L01_原始方式.service.YouKuMemberService;
...
public class DeliverController {
     ...
     * 原始开发方式
     * 缺点：
     * 1.如果要新加奖品，务必需要新增类型对原有代码进行改动。重构成本变高
     * 2.if过多，研发历史包袱会加大，也违反了开闭原则，没有扩展性
     */
